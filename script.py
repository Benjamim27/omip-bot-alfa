...
def obter_data_tabela_omip():
    ...
    # Retorna None para que o script saiba que a leitura falhou e não assuma a data de hoje por erro
    return None
...
if __name__ == "__main__":
    ...
    # Validação de segurança: se o site falhar, para aqui em vez de queimar o JSON histórico
    if not data_atual_omip:
        print("⚠️ Não foi possível obter a data do site. Abortando execução.")
        exit(0)
